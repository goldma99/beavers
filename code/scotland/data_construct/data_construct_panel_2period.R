...
write_dta(panel_2period_g3  , file.path(path_data_clean_treatment, "grid_panel_2period_g3.dta"))
write_dta(panel_2period_g12 , file.path(path_data_clean_treatment, "grid_panel_2period_g12.dta"))
write_dta(panel_2period_g13 , file.path(path_data_clean_treatment, "grid_panel_2period_g13.dta"))
write_dta(panel_2period_g23 , file.path(path_data_clean_treatment, "grid_panel_2period_g23.dta"))
write_dta(panel_2period_g123, file.path(path_data_clean_treatment, "grid_panel_2period_g123.dta"))



#' 
#' # Aggregate to grid-cell-by-t, with all covariates averaged
#' sd_cols <- str_subset(names(river_grid_year_panel_unfilled), "_?mean_?|_max|is_land_class")
#' 
...
#'                                        ][]
#' 
#' ## Only 2017 and 2020-treated ===================
#' river_grid_panel_2period_g23 <-
#'   river_grid_year_panel_unfilled[g != 1,
#'                                  c(.(g = unique(g),
#'                                      lccd_mj_dom = unique(lccd_mj_dom),
#'                                      soil_share_igrg = unique(soil_share_igrg),
#'                                      soil_share_nag = unique(soil_share_nag),
