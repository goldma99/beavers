...
\label{table:beaver_sample_soil_Soverall}
\centering
Table \ref{table:beaver_sample_soil_Soverall} \\
Beaver impacts \\
\begin{threeparttable}
\begin{tabulary}{\textwidth}{l*{9}{c}@{}}
\toprule \toprule
\noalign{\smallskip}
\ExpandableInput{\tabPath/beaver_sample_soil/beaver_sample_soil_DVag_share_Soverall_panel.tex}
\noalign{\smallskip}
\midrule \bottomrule
\end{tabulary}
\medskip
