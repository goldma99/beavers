...
foreach sample_cohort in $samples_cohort {
    ...
    ** Build table container around the two panels created above
    local filename_panel_a "beaver_main_S`sample_cohort'_all_cells_panel"
    local filename_panel_b "beaver_main_S`sample_cohort'_river_cells_panel"
    local filename_table "beaver_main_S`sample_cohort'_table"
    ...
    tex \label{table:beaver_main_`sample_cohort'} 
    tex \centering             
    tex Table \ref{table:beaver_main_`sample_cohort'} \\ 
